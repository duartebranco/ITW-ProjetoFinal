...
var vm = function () {
    ...
    //---Variáveis locais
    var self = this;
    self.baseUri = ko.observable('http://192.168.160.58/NBA/API/Search?q=');
    self.displayName = 'NBA Search';
    ...
    self.activate = function (id) {
        ...
        var composedUri = self.baseUri() + localStorage.getItem('search') +  "&page=" + id + "&pageSize=" + self.pagesize();
